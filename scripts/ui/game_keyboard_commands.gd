	...
	return [
		...
		},
		{
			...
			"entries": [
				...
				{"keys": "Q", "desc": "Claw — tap Q to target, A/D to pick letter in row, release Q then tap Q to grab"},
		...
		},
		{
			...
			"entries": [
				...
				{"keys": "/ / Numpad /", "desc": "Master volume down 10% (hold to repeat)"},
				{"keys": "* / Numpad *", "desc": "Master volume up 10% (hold to repeat)"},
